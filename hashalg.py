    ...
    def sha256(self, text):
        ...
        for chunk in chunks:
            ...
            for i in range(16, 64):
                ...
                # xor operation on items in three lists
                # binary rotation on two lists and logical shift right on third list

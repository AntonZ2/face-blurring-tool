...
class BlurringTool(tk.Tk):
    def __init__(self, *args, **kwargs):
        ...
        for i in (Login, Registration, MainMenu, PageVideo, PagePhoto, VideoPreview, PhotoPreview):
            frame = i(screen, self)
            self.frames[i] = frame
...
# object for the login and registration page of the UI
class Login(tk.Frame):
    def __init__(self, parent, controller):
        ...
        logintitle = tk.Label(self, text="Login to use your saved faces", fg="#584689", font=SUBTITLE_FONT_2)
        logintitle.place(anchor="center", relx=0.5, rely=0.35)

        usernamelabel = tk.Label(self, text="Username:", fg="#584689", font=SUBTITLE_FONT)
        usernamelabel.place(anchor="center", relx=0.35, rely=0.45)

        passwordlabel = tk.Label(self, text="Password:", fg="#584689", font=SUBTITLE_FONT)
        passwordlabel.place(anchor="center", relx=0.35, rely=0.55)

        usernameentry = tk.Entry(self, font=SUBTITLE_FONT, justify="center", textvariable=self.username)
        usernameentry.place(anchor="center", relx=0.54, rely=0.45, relwidth=0.29, relheight=0.07)
...
class PageVideo(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        button_selectface = tk.Button(self, text="Upload Faces to Avoid", fg="#584689", font=SUBTITLE_FONT,
                                      command=lambda:  BlurringTool.avoid_file(parent, self.saveface, 'video'))
...
# object for photo file selection page of the UI
...
# object of page on UI to select save location of blurred photo file and readjust blurring intensity if needed
